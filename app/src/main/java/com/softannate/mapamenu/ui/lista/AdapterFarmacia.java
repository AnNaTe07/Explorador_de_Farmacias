...
public class AdapterFarmacia extends RecyclerView.Adapter<AdapterFarmacia.ViewHolderFarmacia> {
    private ArrayList<Farmacia> listaDeFarmacias;
    private LayoutInflater inflater;

    public AdapterFarmacia(ArrayList<Farmacia> listaDeFarmacias, LayoutInflater inflater){
    ...
    public void onBindViewHolder(@NonNull ViewHolderFarmacia holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Navigation.findNavController(view).navigate(R.id.detalleFarmacia, bundle);
            }
        });
    }
